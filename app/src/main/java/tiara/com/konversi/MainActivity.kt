...
import tiara.com.konversi.R
import tiara.com.konversi.databinding.ActivityMainBinding
import tiara.com.konversi.ApiEndpoint
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.spCountry1.onItemSelectedListener = object : OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                ...
                strCountryCodeSelected1 = strCountryCode[position]
                binding.spCountry1.isEnabled = true
            }
        ...
        binding.spCountry2.onItemSelectedListener = object : OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                ...
                strCountryCodeSelected2 = strCountryCode[position]
                binding.spCountry2.isEnabled = true
            }
